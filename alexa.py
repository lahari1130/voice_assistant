...
def run_alexa():
    ...
    try :
        ...
        if 'hello' in command :
            ...
            print('''i can play songs on youtube , tell you a joke,search on wikipediaa, tell date and time,find your location,open different websites like instagram,youtube,gmail,github,stack overflow.how may i help you?''')

            engine_talk('''i can play songs on youtube ,tell you a joke, search on wikipedia,tell date and time,find your location,open different websites like instagram,youtube,gmail,github,stack overflow,how can i help you''')
            ...
            search = 'https://www.google.com/search?q=+comand'
            ...
            loc = command.replace('locate', '')
                ...
                engine_talk( "Here is the location of loc"+loc)
            ...
            print('good bye, have a nice day 11')
